...
public class CreateAccountTests extends UIBaseClass{
    ...
    public void createNewAccountTestPositive() {
        ...
        String expectedEmail = DataGenerator.genereteRandomEmail("KhusraviM");

        signUpPage.fillUpCreateAccountForm("Khusravi", expectedEmail,"Password@123");
    ...
    public void createNewAccountWithExistingEmail() {
        ...
        signUpPage.fillUpCreateAccountForm("Khusravi", "KhusraviM@hotmail.com", "Hot@Mai1");
